...
/*																			*\
TODO:	Weekly schedule of what you will accomplish
		x	Week 0	(T:10-7) : Create Dummy Email Commence Operation GETSPAM
					(R:10-9) : Project Abstract Due

		x	Week 1	(T:10-14): Obtain, set up, and research all necessary software tools for project
					(R:10-16): (Full Gmail API, OAuth, ClientKeys, Etc..)

		x	Week 2	(T:10-21): Develop String Matching Algorithm (C++)
					(R:10-23):

		x	Week 3	(T:10-28): Create Java framework utilizing our string matching algorithm [Java]
					(R:10-30):
